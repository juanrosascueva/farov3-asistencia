...
export default function ChatPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed bottom-20 lg:bottom-6 right-4 sm:right-6 w-[360px] max-w-[calc(100vw-2rem)] z-50">
      <div className="bg-white border border-ink/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden" style={{ maxHeight: "500px" }}>
