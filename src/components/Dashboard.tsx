  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 2xl:grid-cols-4 gap-5">
        <div className="lg:col-span-2 bg-card rounded-card shadow-soft p-3 sm:p-5">
...
function AlertRow({
  ...
  return (
    <>
      <div
        className={`flex items-start sm:items-center gap-2.5 px-2.5 py-3 sm:p-3 rounded-xl border ${colorMap[r.color]} ${hasPhone ? "" : "cursor-pointer"}`}
      ...
      >
        ...
        >
          ...
          <p className="text-xs opacity-80 leading-tight">{r.action}</p>
          <div className="mt-1">
            <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded border border-current opacity-85">
              {r.label}
            </span>
          </div>
        </div>
        <div className="flex items-center gap-1.5 shrink-0 self-center">
          ...
          {hasPhone && (
            <button
              ...
              className="w-8.5 h-8.5 rounded-xl bg-white/70 hover:bg-white/90 dark:bg-card/40 dark:hover:bg-card/60 flex items-center justify-center transition border border-ink/5 shadow-sm shrink-0 pressable"
            >
