        ...
        <div className="flex items-center gap-1.5 shrink-0 self-center">
          {hasPhone && (
            <button
              ...
              className="w-9 h-9 rounded-xl bg-white/70 hover:bg-white/90 dark:bg-card/40 dark:hover:bg-card/60 flex items-center justify-center transition border border-ink/5 shadow-sm shrink-0 pressable"
            >
