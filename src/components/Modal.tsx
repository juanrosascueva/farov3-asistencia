...
export default function Modal({ title, onClose, children, panelClassName }: ModalProps) {
  ...
  const modalContent = (
    ...
    >
      <div
        ref={ref}
        className={`bg-paper w-full max-w-[calc(100vw-1.5rem)] mx-auto sm:mx-0 sm:w-full sm:max-w-md rounded-2xl sm:rounded-card max-h-[90vh] overflow-y-auto animate-modal-in my-auto ${panelClassName || ""}`}
      >
