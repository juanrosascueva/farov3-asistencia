  ...
  return (
    <ResponsiveSheet title="Mi Perfil" onClose={onClose} desktopMaxWidthClass="sm:max-w-sm">
      <div className="p-4 space-y-4">
        <div>
          <label className="block text-xs font-semibold text-ink/50 mb-1">Nombre</label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-xs font-semibold text-ink/50 mb-1">Nueva Contraseña (opcional)</label>
          <input
            type="password"
            value={password}
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl py-2.5 text-sm transition pressable flex justify-center items-center gap-2"
        >
          {saving && (
